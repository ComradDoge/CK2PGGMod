...
NTechnology = {
	...
	NOMAD_TRIBUTARY_LEECH_RATIO = 30,			-- Nomads leeches 0.01% of the tech growth of their tributaries
...
NDisease = {
	...
	BIG_TOWN_INCOME = 40.0, -- A coastal town with this income is always a candidate for starting an outbreak
